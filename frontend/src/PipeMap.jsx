...
import Pressure from './Pressure'; // Import the Pressure component for the overlay
...
*/
const FitBounds = ({ pipes, selectedPipe }) => {
const map = useMap();
useEffect(() => {
if (selectedPipe) {
...
const PipeMap = ({ pipes, selectedPipe, leakMarker,setMapCenter }) => {
